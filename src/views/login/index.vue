  ...
  <AppPage :show-footer="true" bg-cover :style="{ backgroundImage: `url(${bgImg})` }">
    <div style="transform: translateY(25px)"
      ...
      <div w-320 flex-col px-20 py-35>
        ...
        <div mt-32>
          <n-input v-model:value="loginInfo.name" autofocus class="h-48 items-center text-16" placeholder="name"
            :maxlength="20">
            <template #prefix>
        ...
        <div mt-32>
          <n-input v-model:value="loginInfo.password" class="h-48 items-center text-16" type="password"
            show-password-on="mousedown" placeholder="password" :maxlength="20" @keydown.enter="handleLogin">
            <template #prefix>
